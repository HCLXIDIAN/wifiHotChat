...
import com.ty.hcl.adapter.RoomChatMsgAdapter;
...
public class RoomChat extends Base implements OnClickListener,FaceSelect{
	...
	public void onClick(View v) {
		...
		case R.id.room_chat_send:
			...
			UDPMessage message= ChatApplication.mainInstance.getMyUdpMessage(msg, Listener.TO_ALL_MESSAGE);
			sendMsg(message);
			break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		switch (event.getAction()) {
			case MotionEvent.ACTION_DOWN:
				Util.hideSoftInput(RoomChat.this);//类似QQ,点击聊天空白区域会隐藏输入法
				break;
