	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			UDPMessage message=myMessages.get(position);
				Bitmap bitmap;
				if(message.getDeviceCode().equals(ChatApplication.mainInstance.getDeviceCode()))
			...
			SpannableString spannableString = WChatUtil.getExpressionString(context, message.getMsg(), zhengze);
