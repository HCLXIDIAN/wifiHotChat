...
public abstract class Listener extends Thread{
	...
	public static final int ASK_VIDEO=11;//请求视频聊天
	public static final int REPLAY_VIDEO_ALLOW=12;//请求视频聊天
	public static final int REPLAY_VIDEO_NOT_ALLOW=13;//请求视频聊天
